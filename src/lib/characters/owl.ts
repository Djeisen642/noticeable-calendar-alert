...
const OWL_SVG = `<svg viewBox="0 0 140 190" width="140" height="190" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Ground shadow -->
  <ellipse cx="69" cy="183" rx="34" ry="6" fill="#000000" opacity="0.16" />
  ...
  <g id="head">
    ...
    <!-- Brow ridge over the disc -->
    <path d="M42 44 Q55 34 69 42 Q83 34 96 44" stroke="#5f3a20" stroke-width="3" fill="none" stroke-linecap="round" opacity="0.8" />
    <g id="eyes">
      <circle cx="55" cy="54" r="11.5" fill="#ffb938" />
      <circle cx="55" cy="54" r="11.5" fill="none" stroke="#a86a14" stroke-width="1.6" />
      <circle cx="55" cy="55" r="6" fill="#2b1c10" />
      ...
      <circle cx="83" cy="55" r="6" fill="#2b1c10" />
