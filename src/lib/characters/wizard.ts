...
const WIZARD_SVG = `<svg viewBox="0 0 140 190" width="140" height="190" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="head">
    ...
    <g id="hat">
      <path d="M50 32 Q57 10 67 -4 Q69 -7 73 -8 Q79 -9 81 -5 Q82 -2 78 -1 Q74 -1 72 3 Q68 12 74 24 Q77 29 80 32 Q66 27 50 32 Z" fill="url(#wizHat)" />
      <path d="M56 26 Q61 12 68 0" stroke="#ffffff" stroke-width="2.6" stroke-linecap="round" fill="none" opacity="0.35" />
