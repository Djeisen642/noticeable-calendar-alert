...
const DRAGON_SVG = `<svg viewBox="0 0 140 190" width="140" height="190" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="wing-left">
    <path d="M52 90 Q40 72 30 56 Q24 46 14 40 Q18 52 16 66 Q22 62 24 80 Q29 74 32 94 Q38 86 42 100 Q46 92 52 98 Z" fill="#b5342a" stroke="#3d1210" stroke-width="1.8" />
    <path d="M30 58 L16 66 M30 58 L24 80 M30 58 L32 94 M30 58 L42 100" stroke="#8a1f1a" stroke-width="1.5" fill="none" />
    <path d="M30 56 L25 47 L33 51 Z" fill="#9c2620" stroke="#3d1210" stroke-width="1.2" />
  </g>
  <g id="wing-right">
    <path d="M86 88 Q100 58 126 24 Q136 42 138 58 Q130 52 132 78 Q123 66 120 98 Q112 84 106 110 Q100 94 92 100 Z" fill="#c93a2f" stroke="#3d1210" stroke-width="1.8" />
    <path d="M110 46 L138 58 M110 46 L132 78 M110 46 L120 98 M110 46 L106 110" stroke="#8a1f1a" stroke-width="1.6" fill="none" />
    <path d="M108 44 L104 32 L114 38 Z" fill="#9c2620" stroke="#3d1210" stroke-width="1.2" />
  </g>
  ...
  <!-- Greeting arm: drawn RAISED (same shoulder geometry as the knight so the
       shared tuck/wave choreography fits); cream claws on the paw -->
  <g id="arm-wave">
    <path d="M93 99 Q114 70 120 50" stroke="#3d1210" stroke-width="17" stroke-linecap="round" fill="none" />
    <path d="M93 99 Q114 70 120 50" stroke="#d9453a" stroke-width="13.5" stroke-linecap="round" fill="none" />
    <circle cx="121" cy="47" r="9.5" fill="#c93a2f" stroke="#3d1210" stroke-width="1.6" />
    <path d="M113 41 L107 31 L117 35 Z" fill="#f5e9d0" stroke="#3d1210" stroke-width="1.1" />
    <path d="M120 38 L119 27 L127 34 Z" fill="#f5e9d0" stroke="#3d1210" stroke-width="1.1" />
    <path d="M127 42 L134 33 L131 44 Z" fill="#f5e9d0" stroke="#3d1210" stroke-width="1.1" />
  </g>
