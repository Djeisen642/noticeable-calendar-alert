...
const DRAGON_SVG = `<svg viewBox="0 0 140 190" width="140" height="190" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="head">
    ...
    <path d="M37 39 L39 45 L42 40 Z" fill="#efe4c8" />
    <path d="M45 41 L47 47 L50 42 Z" fill="#efe4c8" />
    <path d="M57 48 Q44 50 30 47 L24 44 Q27 50 34 52 Q46 55 56 52 Z" fill="#8a1f1d" />
    <path d="M28 47 L30 41 L33 48 Z" fill="#efe4c8" />
